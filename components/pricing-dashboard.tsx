      ...
      >
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div>
              <p className="text-sm text-gray-300">Days to Expiry</p>
            ...
            <div>
              <p className="text-sm text-gray-300">Stock Quantity</p>
            ...
            <div>
              <p className="text-sm text-gray-300">Turnover Rate</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="glow-card">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                <span className="text-gray-300">AI Predicted Price:</span>
            ...
            <Alert className="glow-card border-green-500/50">
              ...
              <AlertDescription className="text-gray-300 text-sm">{recommendation.reasoning}</AlertDescription>
            </Alert>
          </CardContent>
        </Card>
        ...
        <Card className="glow-card">
          <CardHeader>
            ...
            <CardDescription className="text-gray-300">Projected price changes over the next 5 days</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="glow-card">
          <CardHeader>
            ...
            <CardDescription className="text-gray-300">Category-specific demand response to pricing</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="chart-container">
              <ResponsiveContainer width="100%" height={200}>
        ...
        <Card className="glow-card">
          <CardHeader>
            ...
            <CardDescription className="text-gray-300">Confidence metrics for this recommendation</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
              <div className="flex justify-between mb-2">
            ...
            <div>
              <div className="flex justify-between mb-2">
                <span className="text-gray-300">Time Sensitivity</span>
                <span className="text-white">
